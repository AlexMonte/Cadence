...
pub(crate) fn state() -> &'static SharedAppState {
...
async fn prepare_browser_storage() -> Result<(), String> {
    cadence::web::prepare_browser_storage().await
}

async fn flush_browser_storage() -> Result<(), String> {
    cadence::web::flush_browser_storage().await
}
...
pub async fn project_save(path: Option<String>) -> Result<String, String> {
    prepare_browser_storage().await?;
    let result = cadence::infrastructure::project_save(state(), path)?;
    flush_browser_storage().await?;
    Ok(result)
}

pub async fn project_save_current() -> Result<String, String> {
    prepare_browser_storage().await?;
    let result = cadence::infrastructure::project_save_current(state())?;
    flush_browser_storage().await?;
    Ok(result)
}
...
pub async fn project_save_as(path: String) -> Result<String, String> {
    prepare_browser_storage().await?;
    let result = cadence::infrastructure::project_save_as(state(), path)?;
    flush_browser_storage().await?;
    Ok(result)
}
...
pub async fn project_recovery_write() -> Result<String, String> {
    prepare_browser_storage().await?;
    let result = cadence::infrastructure::project_recovery_write(state())?;
    flush_browser_storage().await?;
    Ok(result)
}
...
pub async fn project_recovery_clear() -> Result<String, String> {
    prepare_browser_storage().await?;
    let result = cadence::infrastructure::project_recovery_clear(state())?;
    flush_browser_storage().await?;
    Ok(result)
}
