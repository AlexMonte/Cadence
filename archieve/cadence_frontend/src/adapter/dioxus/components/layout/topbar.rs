            ...
            div {
                ...
                div { class: shell_theme::TOPBAR_GROUP,
                    button {
                        id: "add-node",
                        r#type: "button",
                        class: shell_theme::toolbar_button(snapshot.picker_open),
                    ...
                    button {
                        id: "selection-toggle",
                        r#type: "button",
                        class: shell_theme::toolbar_button(snapshot.inspector.open),
                        onclick: move |_| {
                            let next = !state.read().inspector.open;
                            state.write().inspector.open = next;
                        },
                        "Inspector"
                    }
                    button {
